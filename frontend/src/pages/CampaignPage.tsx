              ...
              <div className="max-w-4xl w-full adnd-surface rounded-3xl p-10 mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <div className="mt-4 flex items-center gap-2 text-[#e7c37a] text-[10px] font-black uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity">
                      Manifest Realm
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3" viewBox="0 0 20 20" fill="currentColor">
